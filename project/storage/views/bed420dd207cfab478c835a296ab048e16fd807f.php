...
<?php $__env->startSection("title","مدیریت سایت | لیست سرویس ها"); ?>
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="<?php echo e(baseUrl(httpCheck())."adminpanel/Service-createService"); ?>" class="btn btn-outline-info btn-sm ms-auto">ایجاد سرویس جدید</a>
                               </div>
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make("admin.fa.layout.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bala24.ir-v2\project\view/admin/fa/service/list.blade.php ENDPATH**/ ?>