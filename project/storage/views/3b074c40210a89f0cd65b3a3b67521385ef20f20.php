...
<?php $__env->startSection("title","مدیریت سایت | داشبورد"); ?>
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="px-3">
                                                <img src="<?php echo e(baseUrl(httpCheck())); ?>assets/images/user-illustarator-2.png" class="img-fluid" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make("admin.fa.layout.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bala24.ir-v2\project\view/admin/fa/dashboard/index.blade.php ENDPATH**/ ?>