...
<?php $__env->startSection("title","مدیریت سایت | ویرایش راهنمای سرویس"); ?>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/Service-editGuideServiceProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="guide_id" value="<?php echo e($guideService_info['id']); ?>">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="title" value="<?php echo e($guideService_info['title']??''); ?>"
                                                           class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="brief_description" id="brief_description"
                                                              value="" id="" cols="30"
                                                              rows="5"
                                                              class="form-control"><?php echo e($guideService_info['brief_description']??''); ?></textarea>
...
<?php echo $__env->make("admin.fa.layout.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bala24.ir-v2\project\view/admin/fa/service/guide_edit.blade.php ENDPATH**/ ?>