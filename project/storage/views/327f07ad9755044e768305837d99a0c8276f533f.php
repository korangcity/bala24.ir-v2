...
<?php $__env->startSection("title","مدیریت سایت | لیست اخبار"); ?>
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="<?php echo e(baseUrl(httpCheck())."adminpanel/News-createNews"); ?>" class="btn btn-outline-info btn-sm ms-auto">ایجاد خبر جدید</a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($news['CatTitle']); ?></td>
                                        <td><button type="button"  data-id="<?php echo e($news['id']); ?>"  data-bs-toggle="modal" data-bs-target="#staticBackdrop1" class="btn btn-info btn-sm showBriefdescription">مشاهده</button></td>
                                        <td><button type="button"  data-id="<?php echo e($news['id']); ?>"  data-bs-toggle="modal" data-bs-target="#staticBackdrop2" class="btn btn-success btn-sm showDescription">مشاهده</button></td>
                                        <td><button type="button"  data-id="<?php echo e($news['id']); ?>"  data-bs-toggle="modal" data-bs-target="#staticBackdrop3" class="btn btn-warning btn-sm showNewsDetails">مشاهده</button></td>


                                        <td>
                                            <button type="button" data-id="<?php echo e($news['id']); ?>"
                                        ...
                                        <td>
                                            <div class="form-check form-switch form-switch-success mb-3">
                                                <input data-id="<?php echo e($news['id']); ?>"
                                                       class="form-check-input mx-auto form-control isShow"
                                                       <?php echo e($news['is_show']==1?'checked':''); ?> type="checkbox"
                                                       role="switch" id="SwitchCheck3">
                                            </div>
                                        </td>
                                        <td><?php echo e($news['created_at_jalali']); ?></td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/News-newsEdit-<?php echo e($news['id']); ?>" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
                                                    <li>
                                                        <a href="" data-id="<?php echo e($news['id']); ?>"  class="dropdown-item remove-item-btn delItem">
...
<?php echo $__env->make("admin.fa.layout.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\bala24.ir-v2\project\view/admin/fa/news/list.blade.php ENDPATH**/ ?>