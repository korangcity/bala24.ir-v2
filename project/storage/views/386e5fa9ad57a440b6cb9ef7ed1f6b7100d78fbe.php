...
<head>
    ...
    <link href="<?php echo e(baseUrl(httpCheck())); ?>assets/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>

    <link href="<?php echo e(baseUrl(httpCheck())); ?>assets/css/icons.min.css" rel="stylesheet" type="text/css"/>

    <link href="<?php echo e(baseUrl(httpCheck())); ?>assets/css/app.min.css" rel="stylesheet" type="text/css"/>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="apps-todo.html" class="nav-link"> <span data-key="t-to-do">To Do</span>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarIcons">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="icons-crypto.html" class="nav-link"> <span data-key="t-crypto-svg">Crypto SVG</span>
                                            <span class="badge badge-pill bg-danger" data-key="t-new">New</span></a>
                                    </li>
                                </ul>
                            </div>
...
<?php die; ?><?php /**PATH C:\wamp64\www\bala24.ir-v2\project\view/admin/en/layout/app.blade.php ENDPATH**/ ?>