@php
    ...
    $program_object=new \App\controller\home\Program();
    $programs=$program_object->programs();
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img id="header-lang-imgg" src="{{baseUrl(httpCheck())}}assets/images/flags/ir.svg"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr"
                           title="German">
                            <img src="{{baseUrl(httpCheck())}}assets/images/flags/sa.svg" alt="user-image"
                                 class="me-2 rounded" height="18"> <span class="align-middle">العربی</span>
                        </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="m-0 fw-semibold fs-15"> برنامه ها </h6>
                                </div>
                                <div class="col-auto">
                                    <a href="#" class="btn btn-sm btn-soft-info"> مشاهده همه
                        ...
                        <div class="p-2">
                            @foreach($programs as $key=>$program)
                                @if($key<3)
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="{{$program['link']}}">
                                                <img src="{{baseUrl(httpCheck()).$program['image']}}"
                                                     alt="{{$program['alt']}}">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <span class="position-absolute topbar-badge cartitem-badge fs-10 translate-middle badge rounded-pill bg-info">1</span>
                    </button>
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                <div class="text-center empty-cart" id="empty-cart">
                                    ...
                                    <a href="#" class="btn btn-success w-md mb-3">سفارش دهید</a>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="#" class="text-reset">مورد یک</a>
                                            </h6>
                                            <p class="mb-0 fs-12 text-muted">
                                                کیفیت: <span>10 x $32</span>
                                            </p>
                                        </div>
                                        <div class="px-2">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        {{--                        <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">3<span class="visually-hidden">پیام های خانده نشده</span></span>--}}
                    </button>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                        ...
                        <div class="dropdown-head bg-primary bg-pattern rounded-top">
                            <div class="p-3">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h6 class="m-0 fs-16 fw-semibold text-white"> نوتیفیکیشین ها </h6>
                                    </div>
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge badge-soft-light fs-13"> 1 جدید</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1">
                                                <a href="#" class="stretched-link">
                                                    <h6 class="mt-0 mb-2 lh-base">خوش آمدید برای اطلاعات بیشتر ثبت نام
                                                        نمایید
                                                    </h6>
                                                </a>
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span><i class="mdi mdi-clock-outline"></i> 30 دقیقه قبل</span>
                                                </p>
                                            </div>
                            ...
                            <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel" aria-labelledby="alerts-tab">
                                <div class="w-25 w-sm-50 pt-3 mx-auto">
                                    <img src="{{baseUrl(httpCheck())}}assets/images/svg/bell.svg" class="img-fluid"
                                         alt="user-pic">
                                </div>
                                <div class="text-center pb-5 mt-2">
                                    <h6 class="fs-18 fw-semibold lh-base">تو هیچ نوتیفیکیشنی نداری! </h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="#"><i
                                    ...
                                    class="align-middle">پیام ها</span></a>
                        <a class="dropdown-item" href="#"><i
                                    class="mdi mdi-calendar-check-outline text-muted fs-16 align-middle me-1"></i> <span
                                    class="align-middle">وظیفه ها</span></a>
                        <a class="dropdown-item" href="#"><i
                                    class="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1"></i> <span
                                    class="align-middle">راهنمایی</span></a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i
                                    class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span
                                    class="align-middle">موجودی : <b>5000</b></span></a>
                        <a class="dropdown-item" href="#"><span
                                    class="badge bg-soft-success text-success mt-1 float-end">جدید</span><i
...
<div class="app-menu navbar-menu">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            @include('home.fa.layout.sidebar')
