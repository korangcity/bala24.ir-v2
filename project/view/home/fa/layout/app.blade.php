<!DOCTYPE html>
<html lang="fa" dir="rtl" data-layout="vertical" data-layout-style="detached" data-sidebar="light" data-topbar="dark"
...
@endphp
{{--    <link rel="shortcut icon" href="{{baseUrl(httpCheck()).$setting['favicon']}}">--}}
    ...
    <link href="{{baseUrl(httpCheck())}}home/assets/libs/swiper/swiper-bundle.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{baseUrl(httpCheck())}}home/assets/css/custom.css" rel="stylesheet" type="text/css"/>


    @yield('head')
</head>
<body data-bs-spy="scroll" style="background-color:#fff !important" data-bs-target="#navbar-example">


<div id="layout-wrapper">

    @include("home.fa.layout.header")
...
<div class="customizer-setting d-none d-md-block" style="margin-left:4%;margin-bottom:-13px">
...
<script src="{{baseUrl(httpCheck())}}home/assets/js/app.js"></script>
