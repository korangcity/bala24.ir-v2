...
<head>
    ...
    <meta content="ورود" name="description" />
            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                ...
                                <form class="needs-validation" method="post" action="{{htmlspecialchars(substr($_SERVER["REQUEST_URI"],0,strpos($_SERVER["REQUEST_URI"],'?')))}}">
                                    ...
                                    <div class="mt-4">
                                        <button class="btn btn-info w-100" type="submit">ورود</button>
                                    </div>
                    ...
                    <div class="mt-4 text-center">
                        <p class="mb-0">آیا رمز عبور خود را فراموش کرده اید؟ <a href="/forgot-password" class="fw-semibold text-primary text-decoration-underline">فراموشی رمز عبور </a> </p>
                    </div>
                    <div class="mt-4 text-center">
                        <p class="mb-0">آیا اکانت ندارید؟ <a href="/signup" class="fw-semibold text-primary text-decoration-underline"> ثبت نام </a> </p>
                    </div>
...
<script>
    ...
    Swal.fire({
        html: '<div class="mt-3">' +
            ...
            'style="width:120px;height:120px">' +
            '</lord-icon>' +
            '<div class="mt-4 pt-2 fs-15"><h4>پسورد شما با موفقیت تغییر کرد</h4>' +
            '</div>' +
            '</div>',
        showCancelButton: !1,
        showConfirmButton: 1,
        ...
        window.location.href = "{{baseUrl(httpCheck())."signin"}}";
    })
