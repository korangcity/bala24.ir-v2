...
@section("title","مدیریت سایت | ویرایش نمونه سرویس")
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Service-editSampleServiceProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <select class="js-example-basic-single form-control"
                                                    ...
                                                    @foreach($services as $serviceG)
                                                        <option value="{{$serviceG['id']}}" {{$service["service_id"]==$serviceG['id']?'selected':''}}>{{$serviceG['title']}}</option>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <h4>تصویر شاخص کوچک</h4>
                                                    <img src="{{baseUrl(httpCheck()).$service['image_small']}}" class="img-thumbnail d-block" alt="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea name="pageOgDescription" id="pageOgDescription" cols="30" rows="10">{{$service['page_og_description_seo']}}</textarea>
                                                </div>
    ...
    <script>
        ...
        $(".deleteImg").click(function(){
            ...
            if(chk){
                $.ajax({
                    type:'post',
                    url:'/adminpanel/Service-sampleServiceDeleteImage',
                    data:{image_no:image_no,service_id:service_id},
                    success:function(response){
                        window.location.href='/adminpanel/Service-sampleServiceEdit-'+service_id
                    },
                    error:function(){
                        alert("oops")
                    }
