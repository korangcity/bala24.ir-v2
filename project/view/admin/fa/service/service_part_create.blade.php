...
@section("title","مدیریت سایت | ایجاد قسمت های  سرویس")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1"> ایجاد قسمت های  سرویس</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Service-createServicePartProcess" method="post" enctype="multipart/form-data">
