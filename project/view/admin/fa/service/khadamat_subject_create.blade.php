                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Service-createKhadamatSubjectProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="title_main" value="{{old('title_main')??''}}" class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="main_brief_description" class="form-control" id="main_brief_description" cols="30" rows="5">{{old('main_brief_description')??''}}</textarea>
                                                </div>
                                            </div>
