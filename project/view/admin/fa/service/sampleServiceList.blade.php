...
@section("title","مدیریت سایت | لیست نمونه سرویس ها")
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Service-createSampleService"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد نمونه سرویس جدید</a>
                               </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Service-sampleServiceEdit-{{$service['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
                                                    <li>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(".copyToClipboard").click(function(){
                        var copyText = document.getElementById("clipboardSib");
                        ...
                        Swal.fire({
                            html: '<div class="mt-3">' +
                                ...
                                '</lord-icon>' +
                                '<div class="mt-4 pt-2 fs-15"><h4>لینک مورد نظر با موفقیت کپی شد</h4>' +
                                '</div>' +
                                '</div>',
                            showCancelButton: !1,
                            showConfirmButton: 1,
