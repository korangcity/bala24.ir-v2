                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   <h5 class="card-title mb-0">عناوین خدمات </h5>
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Service-createKhadamatSubject"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد </a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tbody>
                                    @foreach($khadamatSubjects as $khadamat)
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td>{{$khadamat['main_title']}}</td>
                                        <td>{{$khadamat['main_description']}}</td>
                                        <td>
                                            <a href="{{baseUrl(httpCheck()).'adminpanel/Service-khadamatList-'.$khadamat['id']}}" class="btn btn-info">مشاهده</a>
                                        </td>
                                        <td>
                                            <a href="{{baseUrl(httpCheck()).'adminpanel/Service-khadamatList-'.$khadamat['id']}}" class="btn btn-danger">مشاهده</a></td>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Service-editKhadamatSubject-{{$khadamat['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
                                                    <li>
...
@section("script")
    ...
    <script>
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/Service-khadamatSubjectDelete-" + item_id;
            }
        });
