...
@section("title","مدیریت سایت | ویرایش دسته بندی سرویس")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">دسته بندی سرویس</h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Service-serviceCategoryEditProcess" method="post" enctype="multipart/form-data">
...
{{--                                            </div>--}}
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea name="pageDescription" class="form-control" id="pageDescription" cols="30" rows="10">{{$category['page_description_seo']??''}}</textarea>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea name="pageOgDescription" class="form-control" id="pageOgDescription" cols="30" rows="10">{{$category['page_og_description_seo']??''}}</textarea>
                                                </div>
