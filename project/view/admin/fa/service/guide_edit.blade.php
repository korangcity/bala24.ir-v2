...
@section("title","مدیریت سایت | ویرایش راهنمای سرویس")
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Service-editGuideServiceProcess" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="token" value="{{$token}}">
                                        <input type="hidden" name="guide_id" value="{{$guideService_info['id']}}">
                                        <div class="row">


                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="service" class="form-label"> سرویس
                                                        <span class="text-danger">*</span></label>
                                                    <select name="service" id="service" class="form-control js-example-basic-single">
                                                        <option value="">انتخاب کنید</option>
                                                        @foreach($services as $service)
                                                            <option value="{{$service['id']}}" {{$guideService_info['service_id']==$service['id']?"selected":""}}>{{$service['title']}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">عنوان راهنمای سرویس
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="title" value="{{$guideService_info['title']??''}}"
                                                           class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="brief_description" id="brief_description"
                                                              value="" id="" cols="30"
                                                              rows="5"
                                                              class="form-control">{{$guideService_info['brief_description']??''}}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">آیکن راهنمای سرویس
                                                    </label>
                                                    <input type="text" name="icon" value="{{$guideService_info['icon']??''}}"
                                                           class="form-control"
