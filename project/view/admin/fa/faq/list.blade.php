                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="{{baseUrl(httpCheck())."adminpanel/FAQ-createFaq"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد </a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td>{!! html_entity_decode($faq['question']) !!}</td>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/FAQ-editFaq-{{$faq['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
                                                    <li>
                                                        <a href="" data-id="{{$faq['id']}}"  class="dropdown-item remove-item-btn delItem">
...
@section("script")
    ...
    <script>
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/FAQ-faqDelete-" + item_id;
            }
        });
    </script>
@endsection
