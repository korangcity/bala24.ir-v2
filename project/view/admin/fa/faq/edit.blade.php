                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/FAQ-editFaqProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="question" id="editor" cols="30"
                                                      rows="10">{!! html_entity_decode($faq["question"]) !!}</textarea>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="answer" id="editor1" cols="30"
                                                      rows="10">{!! html_entity_decode($faq["answer"]) !!}</textarea>
                                        </div>
