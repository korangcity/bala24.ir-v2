...
@section("title","مدیریت سایت | اطلاعات ثابت faq")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   <h5 class="card-title mb-0"> اطلاعات ثابت faq</h5>
                            ...
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$faq_constant['title']}}</td>
                                        <td>{{$faq_constant['brief_description']}}</td>
                                        <td>{{$faq_constant['first_link_title']}}</td>
                                        <td>{{$faq_constant['first_link_icon']}}</td>
                                        <td>{{$faq_constant['first_link']}}</td>
                                        <td>{{$faq_constant['second_link_title']}}</td>
                                        <td>{{$faq_constant['second_link_icon']}}</td>
                                        <td>{{$faq_constant['second_link']}}</td>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/FAQ-editFaConstant-1" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
