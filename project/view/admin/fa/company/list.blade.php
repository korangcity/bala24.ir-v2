...
@section("title","مدیریت سایت | لیست شرکت ها")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <h5 class="card-title mb-0"> شرکت ها</h5>
                                    <a href="{{baseUrl(httpCheck())."adminpanel/Company-createCompany"}}"
                                       class="btn btn-outline-info btn-sm ms-auto"> شرکت جدید</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center"
                                    ...
                                    @foreach($companies as $company)
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" data-id="{{$company['id']}}" data-bs-toggle="modal"
                                                        data-bs-target="#staticBackdrop3"
                                                        class="btn btn-warning btn-sm showCompanyDetails">مشاهده
                                                </button>
                                            </td>
                                            ...
                                            <td>
                                                <div class="form-check form-switch form-switch-success mb-3">
                                                    <input data-id="{{$company['id']}}"
                                                           class="form-check-input mx-auto form-control isShow"
                                                           {{$company['is_show']==1?'checked':''}} type="checkbox"
                                            ...
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a href="/adminpanel/Company-editCompany-{{$company['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">جزییات شرکت</h5>
...
@section("script")
    ...
    <script>
        ...
        $(".showCompanyDetails").click(function () {

            let company_id = $(this).data("id");
            $.ajax({
                type: 'post',
                url: "/adminpanel/Company-getCompanyDetails",
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/Company-companyDelete-" + item_id;
            }
        });
        ...
        $(".isShow").click(function () {
            ...
            if (chk) {
                $.ajax({
                    type: 'post',
                    url: '/adminpanel/Company-companyIsShow',
                    data: {situation: situation, company_id: company_id},
                    success: function (response) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = "/adminpanel/Company-companyList";
                        })
                    },
                    error: function () {
                        alert("ooos")
