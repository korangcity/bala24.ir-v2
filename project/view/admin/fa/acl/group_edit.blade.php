                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">ویرایش گروه</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endphp
                                    <form action="/adminpanel/Acl-groupEditProcess" method="post"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="form-check {{$colors[array_rand($colors)]}} mb-3">
                                                                        <input class="form-check-input permission"
                                                                               ...
                                                                               id="english" {{$group['language_en']==1?"checked":""}}
                                                                        >
                                                                    ...
                                                                    <div class="form-check {{$colors[array_rand($colors)]}} mb-3">
                                                                        <input class="form-check-input permission"
                                                                               ...
                                                                               id="farsi" {{$group['language_fa']==1?"checked":""}}
                                                                        >
                                                                        <label class="form-check-label"
                                                                               for="farsi">
                                                                            فارسی
                                                                    ...
                                                                    <div class="form-check {{$colors[array_rand($colors)]}} mb-3">
                                                                        <input class="form-check-input permission"
                                                                               type="checkbox"
                                                                               id="arabic"
                                                                               name="arabic" {{$group['language_ar']==1?"checked":""}}
                                                                        >
                                                                        <label class="form-check-label"
                                                                               for="arabic">
                                                                            العربیه
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @foreach($roles as $roleKey=>$role)
                                                            <div class="col-md-3 mt-3 border-bottom">
                                                                <div>
                                                                    <div class="form-check {{$colors[array_rand($colors)]}} mb-3">
                                                                        <input class="form-check-input role rolle{{$roleKey}}"
                                                                               type="checkbox"
                                                                               name="role{{($roleKey+1)}}"
                                                                               id="role{{$roleKey}}"
                                                                               @foreach($group_roles as $group_role)
                                                                                   {{$role['id']==$group_role['roleId']?"checked":""}}
                                                                               @endforeach
                                                                               data-id="{{$role['id']}}">
                                                                        <h2 class=""><label
                                                                            ...
                                                                            <div class="form-check {{$colors[array_rand($colors)]}} mb-3">
                                                                                <input class="form-check-input permission"
                                                                                       ...
                                                                                       @foreach($group_permissions as $group_permission)
                                                                                           {{$permission['permissionId']==$group_permission['permissionId']?"checked":""}}
                                                                                       @endforeach
...
@section("script")
    ...
    <script>
        ...
        $(document).ready(function () {
            let countAll = document.querySelectorAll('.role').length;

            for (i = 0; i < countAll; i++) {
                if ($(".rolle" + i).is(":checked")) {
                    $(".rolle" + i).parent().siblings().children(".permission").attr("disabled", false);
                }
            }
        });
