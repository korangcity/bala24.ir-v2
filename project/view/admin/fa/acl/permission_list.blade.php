                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Acl-createPermission"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد </a>
                               </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Acl-permissionEdit-{{$permission['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
