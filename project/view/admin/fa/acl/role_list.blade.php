                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Acl-createrole"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد </a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$role['label']}}</td>
                                        <td>
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-id="{{$role['id']}}" class="btn btn-outline-danger btn-sm showRolePermissions">مشاهده</button>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Acl-roleEdit-{{$role['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
...
@section("script")
    ...
    <script>
        ...
        $(".showRolePermissions").click(function () {

            let role_id = $(this).data("id");
            $.ajax({
                type: 'post',
                url: "/adminpanel/Acl-getRolePermissions",
