...
@section("title","مدیریت سایت | لیست وبلاگ")
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Blog-createBlog"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد وبلاگ جدید</a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$blog['title']}}</td>
                                        <td>{{$blog['CatTitle']}}</td>
                                        <td><button type="button"  data-id="{{$blog['id']}}"  data-bs-toggle="modal" data-bs-target="#staticBackdrop1" class="btn btn-info btn-sm showBriefdescription">مشاهده</button></td>
                                        <td><button type="button"  data-id="{{$blog['id']}}"  data-bs-toggle="modal" data-bs-target="#staticBackdrop2" class="btn btn-success btn-sm showDescription">مشاهده</button></td>
                                        <td><button type="button"  data-id="{{$blog['id']}}"  data-bs-toggle="modal" data-bs-target="#staticBackdrop3" class="btn btn-warning btn-sm showBlogDetails">مشاهده</button></td>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Blog-blogEdit-{{$blog['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
                                                    <li>
                                                        <a href="" data-id="{{$blog['id']}}"  class="dropdown-item remove-item-btn delItem">
