...
@section("title","مدیریت سایت | لیست پیام ها")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   <h5 class="card-title mb-0"> پیام ها</h5>
                            ...
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button"  data-id="{{$message['id']}}"  data-bs-toggle="modal" data-bs-target="#staticBackdrop1" class="btn btn-info btn-sm showContent">مشاهده</button></td>
                                        <td>
                                            <span class="badge {{$message['is_shown']?"bg-success":"bg-danger"}}">{{$message['is_shown']?"دیده شده":"جدید"}}</span>
                                        </td>


                                        <td>{{\Morilog\Jalali\CalendarUtils::strftime("Y/m/d",strtotime($message['created_at']))}}</td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a href="" data-id="{{$message['id']}}"  class="dropdown-item remove-item-btn delItem">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">محتوا</h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary reloadPage" data-bs-dismiss="modal">بستن</button>
                </div>
            </div>
        </div>
    </div>
...
@section("script")
    ...
    <script>
        ...
        $(".showContent").click(function () {
            ...
            $.ajax({
                type: 'post',
                url: "/adminpanel/Contactus-getMessageContent",
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/Contactus-messageDelete-" + item_id;
            }
        });
    </script>
@endsection
