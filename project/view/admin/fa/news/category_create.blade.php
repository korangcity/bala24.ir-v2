...
@section("title","مدیریت سایت | ایجاد دسته بندی خبر")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">دسته بندی خبر</h4>
                            </div>
...
{{--                                            </div>--}}
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea class="form-control" name="pageDescription" id="pageDescription" cols="30" rows="10">{{old('pageDescription')??''}}</textarea>
                                                </div>
