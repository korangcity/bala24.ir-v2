...
@section("title","مدیریت سایت | ویرایش خبر")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1"> اخبار</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/News-editNewsProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h6 class="fw-semibold">دسته بندی خبر <span
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">عنوان خبر
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="title" value="{{$news["title"]}}"
                                                           class="form-control"
                                                           placeholder="عنوان خبر" id="title">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">متن خبر
                                                <span class="text-danger">*</span></label>
...
{{--                                            </div>--}}
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea name="pageDescription" class="form-control" id="pageDescription" cols="30" rows="10">{{$news['page_description_seo']}}</textarea>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea name="pageOgDescription" class="form-control" id="pageOgDescription" cols="30" rows="10">{{$news['page_og_description_seo']}}</textarea>
                                                </div>
    ...
    <script>
        ...
        $(".addImage").click(function () {
            $(".resultAddImage").append('<div class="d-flex"><div class="col-lg-6">' +
                ...
                '<input type="text" placeholder="مقدار alt تصویر را وارد کنید" class="form-control mb-2" name="newsImageAlts[]">' +
                '</div></div>');
        });
