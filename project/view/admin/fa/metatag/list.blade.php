...
@section("title","مدیریت سایت | لیست متاتگ")
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Metatag-createMetatag"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد متاتگ جدید</a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td>
                                           <span class="badge bg-success">{{$routes[$metatag['page_url']]}}</span>
                                        </td>
                                        <td>
                                            <button type="button" data-id="{{$metatag['id']}}"
                                                    class="btn btn-danger btn-sm getSEOData" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                                جزییات
                                            </button>
                                        </td>

                                        <td>{{\Morilog\Jalali\CalendarUtils::strftime("Y/m/d",strtotime($metatag['created_at']))}}</td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Metatag-editMetatag-{{$metatag['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
                                                    <li>
                                                        <a href="" data-id="{{$metatag['id']}}"  class="dropdown-item remove-item-btn delItem">
