...
@section("title","مدیریت سایت | ویرایش متاتگ")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1"> متاتگ</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/Metatag-editMetatagProcess" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="token" value="{{$token}}">
                                        <input type="hidden" name="metatag_id" value="{{$metatag['id']}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <select name="pageUrl" id="pageUrl" class="form-control">
                                                        <option value="">انتخاب کنید ...</option>
                                                        @for($i=0;$i<count($routes);$i++)
                                                            <option value="{{$routesKey[$i]}}" {{($routesKey[$i]==$metatag['page_url'])?"selected":""}}>{{$routes[$routesKey[$i]]}}</option>
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <input type="text" name="pageTitle" class="form-control"
                                                           ...
                                                           value="{{$metatag['page_title_seo']??''}}" id="pageTitle">
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea name="pageDescription" id="pageDescription" class="form-control" cols="30" rows="10">{{$metatag['page_description_seo']??''}}</textarea>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <input type="text" name="pageKeywords"
                                                           value="{{$metatag['page_keywords_seo']?implode("+",explode(",",$metatag['page_keywords_seo'])):''}}" class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <input type="text" name="pageOgTitle"
                                                           value="{{$metatag['page_og_title_seo']??''}}" class="form-control"
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <textarea name="pageOgDescription" class="form-control" id="pageOgDescription" cols="30" rows="10">{{$metatag['page_og_description_seo']??''}}</textarea>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <div>
                                                        <select name="pageOgType" id="pageOgType"
                                                            ...
                                                            <option value="website" {{$metatag['page_og_type_seo']=="website"?'selected':''}}>
                                                                website
                                                            </option>
                                                            <option value="article" {{$metatag['page_og_type_seo']=="article"?'selected':''}}>
                                                                مقاله
                                                            </option>
                                                            <option value="blog" {{$metatag['page_og_type_seo']=="blog"?'selected':''}}>
                                                                وبلاگ
                                                            </option>
                                                            <option value="book" {{$metatag['page_og_type_seo']=="book"?'selected':''}}>
                                                                کتاب
                                                            </option>
                                                            <option value="game" {{$metatag['page_og_type_seo']=="game"?'selected':''}}>
                                                                بازی
                                                            </option>
                                                            <option value="film" {{$metatag['page_og_type_seo']=="film"?'selected':''}}>
                                                                فیلم
                                                            </option>
                                                            <option value="food" {{$metatag['page_og_type_seo']=="food"?'selected':''}}>
                                                                غذا
                                                            </option>
                                                            <option value="city" {{$metatag['page_og_type_seo']=="city"?'selected':''}}>
                                                                شهر
                                                            </option>
                                                            <option value="country" {{$metatag['page_og_type_seo']=="country"?'selected':''}}>
                                                                کشور
                                                            </option>
                                                            <option value="actor" {{$metatag['page_og_type_seo']=="actor"?'selected':''}}>
                                                                بازیگر
                                                            </option>
                                                            <option value="author" {{$metatag['page_og_type_seo']=="author"?'selected':''}}>
                                                                نویسنده
                                                            </option>
                                                            <option value="politician" {{$metatag['page_og_type_seo']=="politician"?'selected':''}}>
                                                                سیاسی
                                                            </option>
                                                            <option value="company" {{$metatag['page_og_type_seo']=="company"?'selected':''}}>
                                                                شرکت
                                                            </option>
                                                            <option value="hotel" {{$metatag['page_og_type_seo']=="hotel"?'selected':''}}>
                                                                هتل
                                                            </option>
                                                            <option value="restaurant" {{$metatag['page_og_type_seo']=="restaurant"?'selected':''}}>
                                                                رستوران
                                                            </option>
                                                        </select>
                                                    </div>
