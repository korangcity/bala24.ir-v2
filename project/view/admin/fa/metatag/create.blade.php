...
@section("title","مدیریت سایت | ایجاد متاتگ")
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/Metatag-createMetatagProcess" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <select name="pageUrl" id="pageUrl" class="form-control">
                                                        ...
                                                        <option value="{{$routesKey[$i]}}">{{$routes[$routesKey[$i]]}}</option>
