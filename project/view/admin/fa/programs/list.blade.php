...
@section("title","مدیریت سایت | لیست برنامه ها")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   <h5 class="card-title mb-0">برنامه</h5>
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Program-createProgram"}}" class="btn btn-outline-info btn-sm ms-auto">ایجاد </a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$program['link']}}</td>
                                        <td>
                                            <img src="{{baseUrl(httpCheck()).$program['image']}}" alt="" class="rounded ">
                                        </td>
                                        <td>
                                            {{$program['alt']}}
                                        </td>
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Program-editProgram-{{$program['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> ویرایش</a></li>
                                                    <li>
                                                        <a href="" data-id="{{$program['id']}}"  class="dropdown-item remove-item-btn delItem">
...
@section("script")
    ...
    <script>
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/Program-programDelete-" + item_id;
            }
        });
