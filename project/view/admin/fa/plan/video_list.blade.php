...
@section("title","مدیریت سایت | ویدئوها")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <h5 class="card-title mb-0"> ویدئو ها</h5>
                                    <a href="{{baseUrl(httpCheck())."adminpanel/Plan-createVideo"}}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    foreach ($serviceCategories as $item) {
                                                        if($item['id']==$video['service_category_id']){
                                                            echo $item['title'];
                                                        }
                                                    }
                                                @endphp
                                            </td>
                                            <td>{{$video['brief_description']}}</td>

                                            <td>

                                                @php
                                                    foreach (json_decode($video['options']) as $itemm) {
                                                        echo $itemm."<br>";
                                                    }
                                                @endphp
                                            </td>
                                            <td>
                                                <video width="100" controls>
                                                    <source src="{{baseUrl(httpCheck()).$video['video']}}"
                                                            type="video/mp4">

                                                </video>
                                            </td>
                                            <td>
                                                <img style="width:100px" src="{{baseUrl(httpCheck()).$video['poster']}}" alt="">
                                            </td>
                                            <td>
                                                @php
                                                    foreach (json_decode($video['pageable_type']) as $j=>$planable_type) {
                                            ...
                                            <td>
                                                @php
                                                        ...
                                                        foreach (json_decode($video['pageable_id']) as $k=>$planable_idd) {
                                            ...
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a href="/adminpanel/Plan-editVideo-{{$video['id']}}"
                                                               class="dropdown-item edit-item-btn"><i
                                                                        class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                                ویرایش</a></li>
                                                        <li>
                                                            <a href="" data-id="{{$video['id']}}"
...
@section("script")
    ...
    <script>
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/Plan-videoDelete-" + item_id;
            }
        });
