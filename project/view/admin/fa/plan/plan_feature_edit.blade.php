...
@section("title","مدیریت سایت | ویرایش سابپلن")
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Plan-editPlanFeatureProcess" method="post"
                                          enctype="multipart/form-data">
                                        <input type="hidden" name="token" value="{{$token}}">
                                        <input type="hidden" name="plan_feature_id" value="{{$planFeature['id']}}">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="plan" id="plan" class="form-control plansInfo">
                                                        ...
                                                        @foreach($plans as $key=>$plan)
                                                            <option value="{{$plan['id']}}" {{$planFeature["plan_id"]==$plan['id']?"selected":""}}>{{$plan['title']}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="brief_description" class="form-control"
                                                              ...
                                                              rows="10">{{$planFeature['brief_description']??''}}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="icon" value="{{$planFeature['icon']??''}}"
                                                           class="form-control"
                                            ...
                                            <div class="row positiveResult">
                                                @if(!empty(json_decode($planFeature['positive_features'])))
                                                    @foreach(json_decode($planFeature['positive_features']) as $key=>$feature)
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                            <div class="col-md-9">
                                                                <div class="mb-3">
                                                ...
                                                @else
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="mb-3">
                                                                <label for="positive_features" class="form-label"> ویژگی
                                                                    های
                                                                    مثبت </label>
                                                                <input type="text" name="positive_features[]"
                                                                       id="positive_features" placeholder="ویژگی مثبت"
                                                                       class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                            ...
                                            <div class="row negativeResult">
                                                @if(!empty(json_decode($planFeature['negative_features'])))
                                                    @foreach(json_decode($planFeature['negative_features']) as $ke=>$featur)
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                            <div class="col-md-9">
                                                                <div class="mb-3">
                                                ...
                                                @else
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-9">
                                                                <div class="mb-3">
                                                                    <label for="negative_features" class="form-label">ویژگی
                                                                        های
                                                                        منفی </label>
                                                                    <input type="text" name="negative_features[]"
                                                                           id="negative_features"
