...
@section("title","مدیریت سایت | ایجاد زمان پلن")
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Plan-createPlanTimeProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="time_period" id="time_period" class="form-control">
                                                        ...
                                                        <option value="1" {{old("time_period")=="1"?"selected":""}}>ساعتی</option>
                                                        <option value="2" {{old("time_period")=="2"?"selected":""}}>روزانه</option>
                                                        <option value="3" {{old("time_period")=="3"?"selected":""}}>ماهیانه</option>
                                                        <option value="4" {{old("time_period")=="4"?"selected":""}}>سالیانه</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="title_value" value="{{old('title_value')??''}}" class="form-control"
