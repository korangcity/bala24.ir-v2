                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">admin access level</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <h4>Define admin access group named {{$user_name}}</h4>
                                                ...
                                                <div class="card">
                                                    <div class="card-body col-lg-7">
                                                        <div class="vstack gap-3">
                                                            <label for="permission" class="form-label"> Group <span
                                                        ...
                                                        <div class="col-lg-8 mt-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="captcha" class="form-control" id="captcha"
                                                                       placeholder="captcha" pattern="(?=.*\d).{5,}"
                                                                       required>
