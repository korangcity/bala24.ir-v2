...
@section("title","website management | edit admin info")
                                    ...
                                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                        ...
                                        <form action="/adminpanel/Auth-adminEditProcess" method="post"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="civilization_code" class="form-label">civilization
                                                            code</label>
                                                        <input type="text" name="civilization_code" class="form-control"
                                                               id="civilization_code"
                                                               placeholder="Enter civilization_code"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="iban" class="form-label">Iban(Shaba number)</label>
