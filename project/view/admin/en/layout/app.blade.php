...
<head>
    ...
    <link href="{{baseUrl(httpCheck())}}assets/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>

    <link href="{{baseUrl(httpCheck())}}assets/css/icons.min.css" rel="stylesheet" type="text/css"/>

    <link href="{{baseUrl(httpCheck())}}assets/css/app.min.css" rel="stylesheet" type="text/css"/>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        <li class="menu-title"><span data-key="t-menu">Menu1</span></li>
                        <li class="nav-item">
