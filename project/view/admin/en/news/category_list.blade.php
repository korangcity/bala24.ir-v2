...
@section("title","website management | news category")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <a href="{{baseUrl(httpCheck())."adminpanel/News-createNewsCategory"}}"
                                            ...
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a href="/adminpanel/News-newsCategoryEdit-{{$category['id']}}"
...
@section("script")
    ...
    <script>
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/News-newsCategoryDelete-" + item_id;
            }
        });
    </script>
@endsection
