...
@section("title","website management | create news category")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">News Category</h4>
                            </div>
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/News-createNewsCategoryProcess" method="post"
