...
@section("title","website management | edit news")
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/News-editNewsProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h6 class="fw-semibold">News category<span
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">News title
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="title" value="{{$news["title"]}}"
                                                           class="form-control"
                                                           placeholder="news title" id="title">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">News content
                                                <span class="text-danger">*</span></label>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-lg-12">
                                                <div class="justify-content-between d-flex align-items-center mb-3">
                                                    <h5 class="mb-0 pb-1 ">News image (allowed format:
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-lg-12">
                                                    <div class="justify-content-between d-flex align-items-center mb-3">
                                                        <h5 class="mb-0 pb-1 ">News page og:image (allowed format:
                                                            jpg,jpeg,png,svg,gif)</h5>
                                                    </div>
    ...
    <script>
        ...
        $(".addImage").click(function () {
            $(".resultAddImage").append('<div class="d-flex"><div class="col-lg-6">' +
                ...
                '<input type="text" placeholder="Enter alt value" class="form-control mb-2" name="newsImageAlts[]">' +
                '</div></div>');
        });
