...
@section("ogTitle","test")
@section("ogDescription","test")
@section("ogImage","test")
@section("ogType","test")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <a href="{{baseUrl(httpCheck())."adminpanel/Blog-createBlogCategory"}}"
                                            ...
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a href="/adminpanel/Blog-blogCategoryEdit-{{$category['id']}}"
                                                        ...
                                                        <li>
                                                            <a href="" data-id="{{$category['id']}}"
                                                               class="dropdown-item remove-item-btn">
                                                                <i class="ri-delete-bin-fill align-bottom me-2 text-muted delItem"></i>
                                                                Delete
                                                            </a>
                                                        </li>
                                                    </ul>
