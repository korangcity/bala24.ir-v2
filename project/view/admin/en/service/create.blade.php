...
@section("title","website management | create service")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1"> Service</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/Service-createServiceProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h6 class="fw-semibold">Service category <span
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">Service title
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="title" value="{{old('title')??''}}"
                                                           class="form-control"
                                                           placeholder="service title" id="title">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">Service content
                                                <span class="text-danger">*</span></label>
    ...
    <script>
        ...
        $(".addImage").click(function () {
            $(".resultAddImage").append('<div class="d-flex"><div class="col-lg-6">' +
                ...
                '<input type="text" placeholder=" Enter alt value" class="form-control mb-2" name="serviceImageAlts[]">' +
                '</div></div>');
        });
