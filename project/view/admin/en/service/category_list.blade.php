...
@section("title","website management |  service category list")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <a href="{{baseUrl(httpCheck())."adminpanel/Service-createServiceCategory"}}"
                                   class="btn btn-outline-info btn-sm ms-auto">Create new one</a>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center"
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{baseUrl(httpCheck()).$category['category_image']}}" alt=""
                                            ...
                                            <td>
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <a href="/adminpanel/Service-serviceCategoryEdit-{{$category['id']}}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Category SEO Info</h5>
