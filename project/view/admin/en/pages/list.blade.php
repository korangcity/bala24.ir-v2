...
@section("title","website management | pages")
                        ...
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   ...
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Page-createPage"}}" class="btn btn-outline-info btn-sm ms-auto">Create</a>
                               </div>
                            </div>
                            <div class="card-body">
                                <table id="buttons-datatables" class="display table table-bordered text-center" style="width:100%">
                                    ...
                                    <tr>
                                        <td>{{$loop->index+1}}</td>
                                        <td>{{$page['title']}}</td>
                                        <td><button type="button"  data-id="{{$page['id']}}"  data-bs-toggle="modal" data-bs-target="#staticBackdrop1" class="btn btn-info btn-sm showBriefdescription">show</button></td>
                                        <td><button type="button"  data-id="{{$page['id']}}"  data-bs-toggle="modal" data-bs-target="#staticBackdrop2" class="btn btn-success btn-sm showDescription">show</button></td>
                                        <td><button type="button"  data-id="{{$page['id']}}"  data-bs-toggle="modal" data-bs-target="#staticBackdrop3" class="btn btn-warning btn-sm showPageDetails">show</button></td>
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Page-pageEdit-{{$page['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> edit</a></li>
                                                    <li>
...
@section("script")
    ...
    <script>
        ...
        $(".isShow").click(function () {
            ...
            let page_id = $(this).data("id");
            let chk = confirm("Are you sure to show content?");
