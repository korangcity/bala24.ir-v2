...
@section("title","إدارة الموقع | فئات الخدمة")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                               <div class="d-flex">
                                   <h5 class="card-title mb-0">فئات الخدمة</h5>
                                   <a href="{{baseUrl(httpCheck())."adminpanel/Service-createServiceCategory"}}" class="btn btn-outline-info btn-sm ms-auto">إنشاء واحدة جديدة</a>
                               </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a href="/adminpanel/Service-serviceCategoryEdit-{{$category['id']}}" data-id="{{$category['id']}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> يحرر</a></li>
                                                    <li>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">معلومات الخدمة SEO</h5>
...
@section("script")
    ...
    <script>
        ...
        $(".getSEOData").click(function () {
            ...
            $.ajax({
                type: 'post',
                url: "/adminpanel/Service-getServiceCategorySeoInfo",
        ...
        $(".delItem").click(function (e) {
            ...
            if (chk) {
                window.location.href = "/adminpanel/Service-serviceCategoryDelete-" + item_id;
            }
        });
    </script>
@endsection
