...
@section("title","إدارة الموقع |إنشاء فئة الخدمة")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">فئة الخدمة</h4>
                            </div>
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    @endif
                                    <form action="/adminpanel/Service-createServiceCategoryProcess" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="token" value="{{$token}}">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">عنوان الفئة (3 أحرف على
                                                        الأقل) <apan class="text-danger">*</apan></label>
                                                    <input type="text" name="title" value="{{old('title')??''}}"
                                                           class="form-control"
                                                           placeholder="أدخل عنوان الفئة" id="title">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-lg-12">
                                                <div class="justify-content-between d-flex align-items-center mb-3">
                                                    <h5 class="mb-0 pb-1 ">صورة الفئة (التنسيق المسموح به:
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <input type="text" name="pageUrl" class="form-control"
                                                           placeholder="أدخل pageUrl" value="{{old('pageUrl')??''}}" id="pageUrl">
                                                </div>

                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    <label for="pageTitle" class="form-label">Page Title</label>
                                                    <input type="text" name="pageTitle" class="form-control"
                                                           placeholder="أدخل pageTitle"  value="{{old('pageTitle')??''}}" id="pageTitle">
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <input type="text" name="pageDescription" class="form-control"
                                                           placeholder="أدخل pageDescription" value="{{old('pageDescription')??''}}" id="pageDescription">
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <div>
                                                        <select name="pageOgType" id="pageOgType"
                                                            ...
                                                            <option value="website" {{old('pageOgType')=="website"?'selected':''}}>موقع على الإنترنت</option>
                                                            <option value="article" {{old('pageOgType')=="article"?'selected':''}}>مقالة</option>
                                                            <option value="blog" {{old('pageOgType')=="blog"?'selected':''}}>المدونات</option>
                                                            <option value="book" {{old('pageOgType')=="book"?'selected':''}}>الكتاب</option>
                                                            <option value="game" {{old('pageOgType')=="game"?'selected':''}}>لعبه</option>
                                                            <option value="film" {{old('pageOgType')=="film"?'selected':''}}>فيلم</option>
                                                            <option value="food" {{old('pageOgType')=="food"?'selected':''}}>غذاء</option>
                                                            <option value="city" {{old('pageOgType')=="city"?'selected':''}}>مدينة</option>
                                                            <option value="country" {{old('pageOgType')=="country"?'selected':''}}>بلد</option>
                                                            <option value="actor" {{old('pageOgType')=="actor"?'selected':''}}>الممثل</option>
                                                            <option value="author" {{old('pageOgType')=="author"?'selected':''}}> مؤلف</option>
                                                            <option value="politician" {{old('pageOgType')=="politician"?'selected':''}}>سياسي</option>
                                                            <option value="company" {{old('pageOgType')=="company"?'selected':''}}>شركة</option>
                                                            <option value="hotel"{{old('pageOgType')=="hotel"?'selected':''}}>الفندق</option>
                                                            <option value="restaurant" {{old('pageOgType')=="restaurant"?'selected':''}}>مطعم</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
