...
@section("title","إدارة الموقع |تحرير الخدمة")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1"> الخدمة</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/Service-editServiceProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h6 class="fw-semibold">فئة الخدمة <span
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">عنوان الخدمة
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="title" value="{{$service["title"]}}"
                                                           class="form-control"
                                                           placeholder="عنوان الخدمة " id="title">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
    ...
    <script>
        ...
        $(".addImage").click(function () {
            $(".resultAddImage").append('<div class="d-flex"><div class="col-lg-6">' +
                ...
                '<input type="text" placeholder="أدخل القيمة alt للصورة." class="form-control mb-2" name="serviceImageAlts[]">' +
                '</div></div>');
        });
            ...
            if(chk){
                $.ajax({
                    ...
                    success:function(response){
                        window.location.href="/adminpanel/Service-serviceList?success=true"
                    },
                    error:function(){
                        alert("oops")
                    }
