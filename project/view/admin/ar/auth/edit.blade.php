...
@section("title","إدارة الموقع | تحرير معلومات المسؤول")
                                ...
                                <div class="text-center">
                                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                        ...
                                        <form action="/adminpanel/Auth-changeAdminAvatar" method="post"
                                            ...
                                            <input type="submit" value="سجل" class="btn btn-outline-success btn-sm">
                                    ...
                                    <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                        ...
                                        <form action="/adminpanel/Auth-adminEditProcess" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="name" id="name"
                                                               placeholder="اسم" value="{{$user['name']}}">
                                                    </div>
                                                </div>

                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="mobile" class="form-label">التليفون المحمول</label>
                                                        <input type="text" name="mobile" class="form-control"
                                                               id="mobile"
                                                               placeholder="التليفون المحمول" value="{{$user['mobile']}}">
                                                    </div>
                                                </div>

                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="civilization_code" class="form-label">رمز دولي</label>
                                                        <input type="text" name="civilization_code" class="form-control"
                                                               id="civilization_code"
                                                               placeholder="رمز دولي"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="iban" class="form-label">رقم شبعا</label>
                                                        <input type="text" name="iban" class="form-control" id="iban"
                                                               placeholder="رقم شبعا"
                                                               value="{{$user['iban']}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="credit_card_number" class="form-label">رقم البطاقة</label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="hstack gap-2 justify-content-start">
                                                        <button type="submit" class="btn btn-primary ">يحرر</button>
