...
@section("title","إدارة الموقع |قائمة المسؤولين")
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex">
                                    <h5 class="card-title mb-0">قائمة المسؤولين</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" data-id="{{$user['id']}}" data-bs-toggle="modal"
                                                        ...
                                                        class="btn btn-info btn-sm showUserDetails">رأي
                                                </button>
                                            </td>
                                            <td>
...
@section("script")
    ...
    <script>
        ...
        $(".showUserDetails").click(function () {
            ...
            $.ajax({
                type: 'post',
                url: "/adminpanel/Auth-getUserInfoAr",
        ...
        $(".changeSituation").click(function () {
            ...
            let user_id = $(this).data("id");
            let chk = confirm("هل أنت متأكد من تغيير حالة المسؤول؟");
            if (chk) {
                $.ajax({
                    type: 'post',
        ...
        $(".banUser").click(function () {
            ...
            let user_id = $(this).data("id");
            let chk = confirm("هل أنت متأكد من تقييد المستخدم؟");
        ...
        $(".delItem").click(function (e) {
            e.preventDefault();
            let user_id = $(this).data('id');
            let chk = confirm('هل أنت متأكد من حذف المسؤول؟');
            if (chk) {
