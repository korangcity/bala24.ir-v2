...
@section("title","إدارة الموقع |تحرير المدونة")
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1"> مدونة</h4>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    ...
                                    <form action="/adminpanel/Blog-editBlogProcess" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <h6 class="fw-semibold">فئة المدونة <span
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">عنوان مدونة
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="title" value="{{$blog["title"]}}"
                                                           class="form-control"
                                                           placeholder="عنوان مدونة الويب" id="title">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label">نص المدونة
                                                <span class="text-danger">*</span></label>
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <input type="text" name="pageDescription" class="form-control"
                                                           ...
                                                           value="{{$blog['page_description_seo']}}" id="pageDescription">
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-8 mb-3">
                                                    ...
                                                    <input type="text" name="pageOgDescription"
                                                           value="{{$blog['page_og_description_seo']}}" class="form-control"
    ...
    <script>
        ...
        $(".addImage").click(function () {
            $(".resultAddImage").append('<div class="d-flex"><div class="col-lg-6">' +
                ...
                '<input type="text" placeholder="أدخل القيمة alt للصورة." class="form-control mb-2" name="blogImageAlts[]">' +
                '</div></div>');
        });
            ...
            if(chk){
                $.ajax({
                    ...
                    success:function(response){
                        window.location.href="/adminpanel/Blog-blogList?success=true"
                    },
                    error:function(){
                        alert("oops")
                    }
